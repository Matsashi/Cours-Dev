...
<form method="POST" action="<?=URL?>/books/confirm/<?=$book->getId()?>" enctype="multipart/form-data">
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input class="form-control" type="image" id="image" name="oldPicture" src="<?=URL?>public/images/<?=$book->getCover()?>">
    </div>
    <div class="form-group">
      <label for="file" class="form-label mt-4">Nouvelle image</label>
      <input class="form-control" type="file" id="file" aria-describedby="imgHelp" name="picture">
    ...
    <div class="form-group">
      ...
      <embed class="form-control" type="application/pdf" id="image" name="oldPdf" src="<?=URL?>public/pdf/<?=$book->getTitle()?>.pdf" height="750px">
    </div>
    <div class="form-group">
      <label for="pdfFile" class="form-label mt-4">Fichier PDF</label>
      <input class="form-control" type="file" id="pdfFile" aria-describedby="pdfHelp" name="pdf">
      <small id="pdfHelp" class="form-text text-muted">Si le pdf du livre n'est pas le bon, vous pouvez le modifier ici</small>
    </div>
